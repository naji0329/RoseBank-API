...
REST_FRAMEWORK = {
    """
        If we want to globally declare BasicAuthentication and SessionAuthentication in all 
        the view.py classes, we need to specify it in the 
        settings.py file. This way, we don't have to mention it in each class separately.
    """
